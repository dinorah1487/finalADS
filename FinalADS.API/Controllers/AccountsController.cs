...
namespace Banking.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Register(long registroId, [FromBody] NewAccountDto newAccountDto)
        { 
        ...
        [HttpGet]
        public IActionResult GetListPaginated(long articuloId, [FromQuery]int page = 0, [FromQuery]int pageSize = 10)
        {
            try
            {
                List<AccountDto> accounts = _accountQueries.GetListPaginated(articuloId, page, pageSize);
